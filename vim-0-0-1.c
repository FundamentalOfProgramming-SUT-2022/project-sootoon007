...
int undo();
void shift(char *x , long long c , long long n);
int tedadundo = 0;
...
int undo2(char *adun2)
{
    ...
    listundo[tedadundo].xt = (char *)malloc(numbytes10 * sizeof(char));
...
int clp()
{
    ...
    listundo[tedadundo].xt = (char *)malloc(1000 * sizeof(char));
...
int rpc()
{
    ...
    listundo[tedadundo].xt = (char *)malloc((numbytes6 +1 )* sizeof(char));
    for (int ew = 0; ew < numbytes6; ew++)
    {
...
int insert()
{
    ...
    listundo[tedadundo].xt = (char *)malloc(numbytes * sizeof(char));
...
int cop(int flager)
{
    ...
    if (flager == 1)
    {
        ...
        listundo[tedadundo].xt = (char *)malloc(numbytes3 * sizeof(char));
...
int rmv()
{
    ...
    listundo[tedadundo].xt = (char *)malloc(numbytes2 * sizeof(char));
...
int pst()
{
    ...
    listundo[tedadundo].xt = (char *)malloc(numbytes4 * sizeof(char));
